...
Earlier May this year, we went to {{ photo_place(place=37, link="Paynesville") }} to fix up Grandma's old house.

{{ photo(photo=26018, title="Grandma's unit") }}
...
{{ photo(photo=26014, title="Grandma's kitchen") }}
...
{{ photo(photo=26028, title="Loaded car") }}

On the last day, we took Tyla, our dog to the beach.

{{ photo(photo=26055, title="The beach") }}
