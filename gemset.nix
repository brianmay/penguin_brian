{
  ...
  html-proofer = {
    dependencies = ["addressable" "async" "nokogiri" "pdf-reader" "rainbow" "typhoeus" "yell" "zeitwerk"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  io-event = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1gi68wyvccnacz7ly8sf2j50pk09ngpp6kyjz87z5p6wm6apw39m";
      type = "gem";
    };
    version = "1.3.3";
  };
  ...
  jekyll-environment-variables = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1hq1gqn5m6ipyab5z05x4pb9lw9xxm6x3mi8ygh097b59ryjh7jg";
      type = "gem";
    };
    version = "1.0.1";
  };
  ...
  RbST = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0z4iraimf9lhfvba2ivjmg1m8v3na24plsz4ywigqr904aglnjlk";
      type = "gem";
    };
    version = "0.6.5";
  };
